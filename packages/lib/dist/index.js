...
var briefSchema = import_zod.z.object({
  businessName: import_zod.z.string().min(2),
  tagline: import_zod.z.string().min(2),
  description: import_zod.z.string().min(10),
  vertical: import_zod.z.string().min(2)
});
var designSchema = import_zod.z.object({
  colors: import_zod.z.record(import_zod.z.string(), import_zod.z.string()).optional(),
  fonts: import_zod.z.record(import_zod.z.string(), import_zod.z.string()).optional()
});
var generateSchema = import_zod.z.object({
  draftId: import_zod.z.string().uuid()
});
